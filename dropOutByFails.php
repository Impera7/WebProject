...
<head>
    ...
    <body>
    <h3>Тези студенти ще отпаднат поради брой невзети изпити!</h3>
       <table class="center">
       <tr>
            <th>FN</th>
            <th>First name</th>
       ...
       <?php
            ...
            $sql = "SELECT fn, fname, lname, major, _year, _group, failedExams FROM STUDENTS WHERE failedExams>=3";
            ...
            if($result->num_rows>0){
                while($row = $result->fetch_assoc()){
                    ...
                    . "</td><td>" . $row["_group"] . "</td><td>" . $row["failedExams"] . "</td></tr>";
                }
            echo "</table>";
            }
            else{
